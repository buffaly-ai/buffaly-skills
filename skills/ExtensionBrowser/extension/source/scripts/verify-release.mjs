...
check(!sidepanelSource.includes("url.searchParams.set('installationRegistrationId'"), 'sidepanel conversation URL must not restore the obsolete unauthenticated installation catalog gate after authenticated open');
