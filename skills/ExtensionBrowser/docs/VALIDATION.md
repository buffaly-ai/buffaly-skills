# Buffaly Browser Agent 0.2.11 validation

0.2.11 keeps reusable installation authorization in the MV3 service worker and navigates the side-panel iframe with only a single-use conversation token.

Validated 2026-07-26 on Windows Google Chrome:

- `npm run release:check`: PASS
- TypeScript typecheck and WXT production build: PASS
- Chrome MV3 archive: `Buffaly-Browser-Agent-0.2.11-chrome.zip`
