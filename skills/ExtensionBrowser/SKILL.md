...
- `extension/release/Buffaly-Browser-Agent-0.2.61-chrome.zip`: validated Chrome package produced by `npm run release:check` and distributed through the ExtensionBrowser WebModule installer.
