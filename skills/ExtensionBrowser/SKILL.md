...
- `extension/release/Buffaly-Browser-Agent-0.2.21-chrome.zip`: Chrome Web Store upload artifact produced by `npm run release:check`.
...
The generated archive must match version 0.2.21 and pass `scripts/verify-release.mjs` before staging the indexed release artifact.
