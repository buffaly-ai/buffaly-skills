...
- `ToAttachNamedSessionToWorkspace` accepts an exact existing target session key, delegates to the same idempotent/conflict-safe link owner, and verifies membership through the workspace session list.
