IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE Specific_Name = 'GetSessionSubscriptionsSp_PagingSp')
BEGIN
	DROP PROCEDURE GetSessionSubscriptionsSp_PagingSp
END
GO
...
GO
CREATE PROCEDURE [dbo].[GetSessionSubscriptionsSp_PagingSp]
	@Search [nvarchar](255),
