IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE Specific_Name = 'Sessions_GetArchivedSp_Sp_PagingSp')
BEGIN
	DROP PROCEDURE Sessions_GetArchivedSp_Sp_PagingSp
END
GO
...
GO
CREATE PROCEDURE [dbo].[Sessions_GetArchivedSp_Sp_PagingSp]
	@Search [nvarchar](255),
