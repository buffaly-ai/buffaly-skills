...
if (typeof window === "undefined" || typeof window.SessionSubscriptionsAdminValidatorsFields !== "object") {
	var SessionSubscriptionsAdminValidatorsFields = {};
} else {
	// reuse the existing object created by an earlier script
	var SessionSubscriptionsAdminValidatorsFields = window.SessionSubscriptionsAdminValidatorsFields;
}
	


if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("SessionSubscriptionID")) {
	SessionSubscriptionsAdminValidatorsFields.SessionSubscriptionID = {Validators : [Validators.Text], InvalidMessage: "Invalid SessionSubscriptionID"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("SortAscending")) {
	SessionSubscriptionsAdminValidatorsFields.SortAscending = {Validators : [Validators.Text], InvalidMessage: "Invalid SortAscending"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("NumRows")) {
	SessionSubscriptionsAdminValidatorsFields.NumRows = {Validators : [Validators.Text], InvalidMessage: "Invalid NumRows"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("FieldName")) {
	SessionSubscriptionsAdminValidatorsFields.FieldName = {Validators : [Validators.Text], InvalidMessage: "Invalid FieldName"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("Value")) {
	SessionSubscriptionsAdminValidatorsFields.Value = {Validators : [Validators.Text], InvalidMessage: "Invalid Value"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("PreOptions")) {
	SessionSubscriptionsAdminValidatorsFields.PreOptions = {Validators : [Validators.Text], InvalidMessage: "Invalid PreOptions"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("SkipRows")) {
	SessionSubscriptionsAdminValidatorsFields.SkipRows = {Validators : [Validators.Text], InvalidMessage: "Invalid SkipRows"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("SortColumn")) {
	SessionSubscriptionsAdminValidatorsFields.SortColumn = {Validators : [Validators.Text], InvalidMessage: "Invalid SortColumn"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("Name")) {
	SessionSubscriptionsAdminValidatorsFields.Name = {Validators : [Validators.Text], InvalidMessage: "Invalid Name"};
}
	
if (!SessionSubscriptionsAdminValidatorsFields.hasOwnProperty("Search")) {
	SessionSubscriptionsAdminValidatorsFields.Search = {Validators : [Validators.Text], InvalidMessage: "Invalid Search"};
}
	

	
class SessionSubscriptionsAdminService {
    constructor({ baseUrl = "/api/buffaly.sessions.web/session-subscriptions-admin", authToken = null } = {}) {
        this.Url = baseUrl;
    ...
    GetDetails(SessionSubscriptionID, Callback) {
        return this.GetDetailsObject({ SessionSubscriptionID:SessionSubscriptionID }, Callback);
    }

    GetDetailsObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetDetails, this.GetDetails.onValidationError);
    ...
    async GetDetailsAsync(SessionSubscriptionID) {
    ...
    GetDropDownObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetDropDown, this.GetDropDown.onValidationError);
    ...
    GetDropDownWithNullObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetDropDownWithNull, this.GetDropDownWithNull.onValidationError);
    ...
    GetEdit(SessionSubscriptionID, Callback) {
        return this.GetEditObject({ SessionSubscriptionID:SessionSubscriptionID }, Callback);
    }

    GetEditObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetEdit, this.GetEdit.onValidationError);
    ...
    async GetEditAsync(SessionSubscriptionID) {
        return await ObjectUtil.Promisify(
            this,
            this.GetEdit,
            [ SessionSubscriptionID ]
    ...
    GetGridCountObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetGridCount, this.GetGridCount.onValidationError);
    ...
    GetGridHtmlObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetGridHtml, this.GetGridHtml.onValidationError);
    ...
    GetInsertObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.GetInsert, this.GetInsert.onValidationError);
    ...
    InitializeObject(oObject, Callback) {
        this._validate(oObject, SessionSubscriptionsAdminValidators.Initialize, this.Initialize.onValidationError);
...
var SessionSubscriptionsAdminValidators = {
    

    GetDetails : {
            SessionSubscriptionID : {Validators: [Validators.Text], InvalidMessage: "Invalid SessionSubscriptionID"} 
    },
...
if (typeof SessionSubscriptionsAdmin === "undefined")
{
	// Create a global instance for backward compatibility with original usage
	var SessionSubscriptionsAdmin = new SessionSubscriptionsAdminService();
}
