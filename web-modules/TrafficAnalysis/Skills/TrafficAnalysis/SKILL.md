...
Collectors are independent: each catches and records only its own source failure. The aggregator consumes every available envelope and always produces an email from usable inputs.
