IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE Specific_Name = 'GetSessionsSp_PagingSp')
BEGIN
	DROP PROCEDURE GetSessionsSp_PagingSp
END
GO
...
GO
CREATE PROCEDURE [dbo].[GetSessionsSp_PagingSp]
	@Search [nvarchar](255),
