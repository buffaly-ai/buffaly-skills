IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE Specific_Name = 'GetSessionSubscriptionsBySessionIDSp_CountSp')
BEGIN
	DROP PROCEDURE GetSessionSubscriptionsBySessionIDSp_CountSp
END
GO
...
GO
CREATE PROCEDURE [dbo].[GetSessionSubscriptionsBySessionIDSp_CountSp]
	@SessionID [int],
	@Search [nvarchar](255)
AS
