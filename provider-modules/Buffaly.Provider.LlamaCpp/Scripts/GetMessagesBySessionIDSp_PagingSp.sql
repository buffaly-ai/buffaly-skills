IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE Specific_Name = 'GetMessagesBySessionIDSp_PagingSp')
BEGIN
	DROP PROCEDURE GetMessagesBySessionIDSp_PagingSp
END
GO
...
GO
CREATE PROCEDURE [dbo].[GetMessagesBySessionIDSp_PagingSp]
	@SessionID [int],
	@Search [nvarchar](255),
